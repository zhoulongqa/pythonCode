...
class ParseExcel(object):
    ...
    def getColumn(self,sheet,colNo):
        #获取sheet中第一列，返回的是这一列所有的数据内存组成tuple
        #下标从1开始，sheet.column[1]表示第一列
        try:
    ...
    def writeCell(self,sheet,content,coordinate=None,rowNo=None,colsNo=None,style=None):
        #根据单元格在excel中的编码坐标或者数字索引图标向单元格中插入数据
...
if __name__=="__main__":
    ...
    pe.writeCell(sheet,u"我爱祖国",rowNo=1,colsNo=10)
